...
| `SECURE_TMPDIR` | Secure temp dir override used by editor workflows. | ✅ Implemented (non-Linux secure temp selection) |
| `TMPDIR` | Fallback temp dir for secure editing path. | ✅ Implemented (non-Linux fallback path) |
